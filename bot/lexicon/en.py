...
EN: dict[str, Any] = {
    ...
    "btn_quiet_weekend_on": "🏖 Weekend window: ON",
    "btn_quiet_weekend_off": "🏖 Weekend window: OFF",
    "btn_quiet_weekend_start": "🌙 Weekend start: {time}",
    ...
    "btn_tz_migrate_all": "✅ Migrate all",
    "btn_tz_migrate_pick": "📝 Choose habits",
    "btn_tz_migrate_none": "🚫 Leave as is",
    "tz_migrate_pick_intro": "Tick the habits to migrate to the new timezone (⬜ = leave as is), then tap Apply.",
    "btn_tz_migrate_apply": "✅ Apply",
    "btn_tz_migrate_back": "🔙 Back",
    "tz_migrate_summary_title": "✅ Timezone: `{tz}`",
    "tz_migrate_summary_migrated": "\n\n*Migrated ({count}):*\n{lines}",
    "tz_migrate_summary_migrated_line": "• {habit} — still at {time}",
    "tz_migrate_summary_kept": "\n\n*Left as is ({count}):*\n{lines}",
    "tz_migrate_summary_kept_line": "• {habit} — will fire at {time} instead of {old_time}",
    "tz_migrate_summary_more": "… and {count} more",
    ...
    "export_data_caption": "📤 Your data export: tasks, habits, and settings.",
    "export_data_error": "❌ Failed to export data. Try again later.",
    ...
    # Telegram Stars donations — 5.1 (voluntary, not a paywall)
    "btn_donate": "☕ Support Porabot",
    "donate_prompt": "☕ Enjoying Porabot? You can support development with Telegram Stars — pick an amount:",
    "donate_invoice_title": "Support Porabot",
    ...
    "repeat_every_n_weeks": "Every {n} weeks",
    "repeat_monthly_day": "Day {day} of the month",
    "repeat_last_weekday": "Last workday of the month",
    "repeat_month": "Monthly",
    "repeat_end_none": "unlimited",
    "repeat_end_count_label": "{count} times",
    "repeat_end_until_label": "until {date}",

    # Repeat (RRULE) builder — 3.1
    "repeat_builder_title": "🔁 Configure repeat:",
    "btn_repeat_none": "🚫 No repeat",
    "btn_repeat_daily": "📆 Every day",
    "btn_repeat_weekdays_opt": "💼 Weekdays (Mon–Fri)",
    "btn_repeat_weekend_opt": "🏖 Weekend (Sat–Sun)",
    "btn_repeat_weekly": "🗓 Weekly (same day)",
    "btn_repeat_interval": "🔢 Every N days",
    "btn_repeat_custom_days": "☑️ Pick weekdays",
    "btn_repeat_monthly": "📅 Monthly on day",
    "btn_repeat_last_weekday": "🏁 Last workday of month",
    "btn_repeat_end": "⏳ End: {end}",
    "btn_repeat_back": "🔙 Back",
    "btn_repeat_done_days": "✅ Done",
    "btn_repeat_end_none": "♾ Unlimited",
    "btn_repeat_end_count": "🔢 After N times",
    "btn_repeat_end_until": "📅 Until date",
    "repeat_interval_prompt": "Every how many days? Send a number (e.g. 3).",
    "repeat_interval_invalid": "❌ Send a whole number from 1 to 365.",
    "repeat_monthday_prompt": "Which day of the month? Send a number from 1 to 28.",
    "repeat_monthday_invalid": "❌ Send a number from 1 to 28.",
    "repeat_weekday_pick_title": "Pick the days of the week:",
    "repeat_weekday_pick_empty": "❌ Pick at least one day.",
    "repeat_end_count_prompt": "Stop after how many repeats? Send a number from 1 to 999.",
    "repeat_end_count_invalid": "❌ Send a number from 1 to 999.",
    "repeat_end_date_prompt": "Repeat until which date? Send DD.MM.YYYY.",
    "repeat_end_date_invalid": "❌ Send a future date as DD.MM.YYYY.",
    ...
    "ask_hour_for_date": "Got {date}. What time should I remind you?\n\n📌 Task: {text}",
