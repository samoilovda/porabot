...
ES.update(
    {
        ...
        "btn_quiet_weekend_on": "🏖 Ventana de fin de semana: SÍ",
        "btn_quiet_weekend_off": "🏖 Ventana de fin de semana: NO",
        "btn_quiet_weekend_start": "🌙 Inicio (fin de semana): {time}",
        ...
        "btn_tz_migrate_all": "✅ Migrar todos",
        "btn_tz_migrate_pick": "📝 Elegir hábitos",
        "btn_tz_migrate_none": "🚫 Dejar como están",
        "tz_migrate_pick_intro": "Marca los hábitos que quieres migrar a la nueva zona horaria (⬜ = dejar como está) y pulsa Aplicar.",
        "btn_tz_migrate_apply": "✅ Aplicar",
        "btn_tz_migrate_back": "🔙 Atrás",
        "tz_migrate_summary_title": "✅ Zona horaria: `{tz}`",
        "tz_migrate_summary_migrated": "\n\n*Migrados ({count}):*\n{lines}",
        "tz_migrate_summary_migrated_line": "• {habit} — sigue a las {time}",
        "tz_migrate_summary_kept": "\n\n*Dejados como están ({count}):*\n{lines}",
        "tz_migrate_summary_kept_line": "• {habit} — sonará a las {time} en vez de {old_time}",
        "tz_migrate_summary_more": "… y {count} más",
        ...
        "btn_filter_recurring": "🔁 Recurrentes",
        "btn_filter_back": "🔙 Todas las tareas",
        "find_usage": "Uso: /find texto",
        ...
        "paysupport_no_payments": "No tienes donaciones registradas para reembolsar.",
        "paysupport_intro": "Tus donaciones recientes — toca una para solicitar un reembolso:",
        "paysupport_item": "⭐ {amount} — {date}",
        "btn_paysupport_refund": "↩ Reembolsar {amount} ⭐",
        "paysupport_refund_success": "✅ Reembolsado.",
        "paysupport_refund_failed": "❌ No se pudo reembolsar. Puede que ya esté reembolsado.",
